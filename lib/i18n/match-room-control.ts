...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    description: "Disabling stops new rooms, messages, assistance requests and resolutions, and read acknowledgments. Existing transcripts remain available. Tournament operations and other notifications continue.",
  ...
  it: {
    ...
    description: "La disattivazione blocca nuove stanze, messaggi, richieste e risoluzioni di assistenza e conferme di lettura. Le conversazioni esistenti restano disponibili. Le operazioni del torneo e le altre notifiche continuano.",
  ...
  es: {
    ...
    description: "Al desactivar, se detienen las nuevas salas, los mensajes, las solicitudes y resoluciones de ayuda y las confirmaciones de lectura. Los historiales siguen disponibles. Las operaciones del torneo y las demás notificaciones continúan.",
  ...
  fr: {
    ...
    description: "La désactivation bloque les nouveaux salons, messages, demandes et résolutions d’aide et confirmations de lecture. Les conversations existantes restent disponibles. Le tournoi et les autres notifications continuent.",
  ...
  ko: {
    title: "경기 대화방 활동",
    description: "비활성화하면 새 대화방, 메시지, 도움 요청과 해결 및 읽음 확인이 중단됩니다. 기존 대화는 계속 볼 수 있습니다. 대회 운영과 다른 알림은 계속됩니다.",
  ...
  "pt-BR": {
    ...
    description: "Desativar bloqueia novas salas, mensagens, solicitações e resoluções de ajuda e confirmações de leitura. As conversas existentes continuam disponíveis. As operações do torneio e outras notificações continuam.",
  ...
  ru: {
    ...
    description: "Отключение блокирует новые комнаты, сообщения, создание и закрытие запросов помощи и отметки о прочтении. Существующие переписки остаются доступными. Проведение турнира и другие уведомления продолжаются.",
  ...
  "zh-CN": {
    title: "比赛聊天室活动",
    description: "禁用后将停止创建聊天室、发送消息、发起和处理求助以及更新已读状态。现有聊天记录仍可查看。赛事运行和其他通知不受影响。",
