...
const dictionary = {
  resultUx: {
    ...
    game: "게임 {number}",
    you: "나",
    chooseReplay: ".rec 파일 선택",
    replaceReplay: "리플레이 교체",
    removeReplay: "리플레이 제거",
    gameReplay: "게임 {number} 리플레이",
    replayHint: "진행한 순서대로 게임마다 .rec 리플레이 한 개를 첨부하세요. 파일당 최대 10 MiB입니다.",
    replayAttached: "리플레이 첨부됨",
    derivedWinner: "결과에 따라 자동 결정됨",
    addNote: "+ 메모 추가",
    summary: "결과 요약",
    namedResult: "{winner} 선수가 {loser} 선수를 {winnerScore}–{loserScore}로 이겼습니다",
    filesAttached: "리플레이 {total}개 중 {count}개 첨부됨",
    afterSubmit: "상대에게 결과 확인 또는 이의 제기를 요청합니다.",
    submit: "결과 제출",
    completeRequired: "결과를 선택하고 모든 게임의 유효한 리플레이와 남은 승자를 입력하세요.",
    waiting: "상대의 확인 대기 중",
    reconcileTitle: "제출 상태 확인",
    refreshSaved: "제출 내용이 저장되었습니다. 새로고침하여 공식 상태를 확인하세요.",
    refresh: "경기 새로고침",
    noShow: "상대가 불참했나요? 불참 신고",
    confirmationInfo: "결과 확인",
    windowEnded: "확인 기한 종료",
    processing: "자동 확인을 처리하고 있습니다.",
    opponentWindow: "상대는 제출 후 {minutes}분 이내에 결과를 확인하거나 이의를 제기할 수 있습니다.",
    yourWindow: "제출 후 {minutes}분 이내에 결과를 확인하거나 이의를 제기할 수 있습니다.",
    confirmationExplanation: "공식 확인 기한 전에 확인하거나 이의를 제기하세요.",
    autoExplanation: "확인 기한까지 아무 조치도 없으면 결과가 자동으로 확정됩니다.",
    remaining: "{minutes}분 {seconds}초 남음",
    confirmationDeadline: "확인 마감:",
    autoConfirmed: "결과 자동 확정됨",
    confirmed: "결과 확정됨",
    underReview: "관리자 검토 중",
    confirmationRequired: "결과 확인 필요",
    youReported: "내가 보고한 결과:",
    reportedBy: "{name} 선수가 보고한 결과:",
    filesSubmitted: "제출된 리플레이: {count}개",
    expiredConfirmed: "이의 제기 없이 확인 기한이 만료되었습니다.",
    advanced: "승자가 진출했습니다.",
    reviewExplanation: "관리자가 이 보고와 증거를 검토하고 있습니다.",
    stale: "보고 내용이 변경되었습니다. 다른 작업 전에 경기를 새로고침하세요.",
    actionFailed: "작업을 완료하지 못했습니다. 경기를 새로고침하고 현재 상태를 확인하세요.",
    confirm: "결과 확인",
    dispute: "결과 이의 제기",
    sendDispute: "관리자에게 이의 제기 제출",
    details: "제출 상세 보기",
    discord: "Discord 지원 티켓 열기",
    discordHelp: "티켓에 대회, 라운드, 상대 이름과 문제에 대한 간단한 설명을 포함하세요.",
    bestOf: "{count}전제",
    matchDeadline: "경기 마감:",
  },
  tournaments: {
    redesign: {
      viewArtwork: "대회 이미지 보기",
      viewEvent: "대회 보기",
      showFewer: "대회 접기",
      browseAll: "전체 대회 {count}개 보기",
      otherEvents: "다른 진행 대회 · {count}",
      showLess: "접기",
      readDescription: "전체 설명 읽기",
      selectedEvent: "선택한 대회",
      viewMaps: "맵 보기",
      openArchive: "기록 열기",
      historicalCount: "지난 대회 · {count}",
      mapDivision: "디비전",
      chooseEvent: "대회 둘러보기",
      panelNavigation: "대회 정보",
    },
    ...
    status: { open: "열림", inProgress: "진행 중", completed: "완료", cancelled: "취소됨", closed: "닫힘", notHeld: "미개최", generated: "생성됨", awaitingGeneration: "생성 대기", pendingReview: "검토 대기", upcoming: "예정" },
    divisionState: { disabled: "비활성화됨", filling: "참가자 모집 중 — {approved}/{required}", ready: "시작 준비 완료 — {approved}/{required}", inProgress: "진행 중", completed: "완료", notHeld: "미개최 — 최소 참가 인원 미달", cancelled: "취소됨", voided: "무효 처리됨" },
    eventSections: { in_competition: "경기 진행 중", open: "접수 중인 이벤트", resolved: "종료된 이벤트" },
    hero: { tournament: "토너먼트", approvedSlots: "승인된 자리", divisionInProgress: "디비전 진행 중", divisionNotHeld: "최소 참가 인원 미달", waitlistOpen: "대기 명단 열림", openEvents: "열린 이벤트", scheduleHint: "토너먼트 일정 확인" },
    ...
    registrationState: {
      notHeldTitle: "디비전 미개최", notHeldDescription: "최소 참가 인원을 충족하지 못했습니다. 등록 기록은 이벤트 이력에 보존되며 경기 포인트는 부여되지 않았습니다.",
  ...
  resultForm: {
    ...
    preparing: "안전한 리플레이 업로드 준비 중…",
    uploading: "{total}게임 중 {current}게임 업로드 중…",
