...
const dictionary = {
  nav: {
    ...
    signIn: "Entrar",
    support: "Suporte",
    supportTrigger: "Abrir suporte",
    supportMessage: "Abra um ticket conosco para obter suporte no Discord.",
    openDiscordSupport: "Abrir suporte no Discord",
    announcements: "Anúncios",
    announcementsUnread: "Anúncios — novo anúncio oficial",
