...
const dictionary = {
  matchRoomAttention: {
    opponent: "对手发来新消息",
    admin: "IronClad 管理员新消息",
    generic: "对局聊天室有新消息",
    unreadDescription: "对局聊天室有未读消息。打开对局并阅读最新消息后，提示将消失。",
  },
  resultUx: {
    won: "获胜",
    lost: "落败",
    ...
    game: "第 {number} 局",
    you: "你",
    chooseReplay: "选择 .rec 文件",
    replaceReplay: "替换录像",
    removeReplay: "移除录像",
    gameReplay: "第 {number} 局录像",
    replayHint: "按比赛顺序为每局附上一份 .rec 录像。每个文件最大 10 MiB。",
    replayAttached: "已附加录像",
    derivedWinner: "根据结果自动确定",
    addNote: "+ 添加备注",
    summary: "结果摘要",
    namedResult: "{winner} 以 {winnerScore}–{loserScore} 击败了 {loser}",
    filesAttached: "已附加 {count}/{total} 份录像",
    afterSubmit: "系统将请对手确认或质疑此结果。",
    submit: "提交结果",
    completeRequired: "请选择结果，为每局附上有效录像，并选择尚未确定的各局胜者。",
    waiting: "等待对手确认",
    reconcileTitle: "检查提交状态",
    refreshSaved: "提交已保存。刷新以查看官方状态。",
    refresh: "刷新比赛",
    noShow: "对手未到场？报告缺席",
    confirmationInfo: "结果确认",
    windowEnded: "确认期限已结束",
    processing: "正在处理自动确认。",
    opponentWindow: "对手须在提交后 {minutes} 分钟内确认或质疑此结果。",
    yourWindow: "你须在提交后 {minutes} 分钟内确认或质疑此结果。",
    confirmationExplanation: "请在官方确认截止时间前确认或提出质疑。",
    autoExplanation: "如确认期限内无人操作，系统将自动确认结果。",
    remaining: "剩余 {minutes} 分 {seconds} 秒",
    confirmationDeadline: "确认截止时间：",
    autoConfirmed: "结果已自动确认",
    confirmed: "结果已确认",
    underReview: "管理员审核中",
    confirmationRequired: "需要确认结果",
    youReported: "你报告了：",
    reportedBy: "{name} 报告了：",
    filesSubmitted: "已提交录像：{count}",
    expiredConfirmed: "确认期限已结束，期间未收到质疑。",
    advanced: "胜者已晋级。",
    reviewExplanation: "管理员正在审核此报告及其证据。",
    stale: "此报告已变更。请刷新比赛后再操作。",
    actionFailed: "无法完成操作。请刷新比赛并查看当前状态。",
    confirm: "确认结果",
    dispute: "质疑结果",
    sendDispute: "提交质疑以供管理员审核",
    details: "查看提交详情",
    discord: "打开 Discord 支持工单",
    discordHelp: "请在工单中说明赛事、轮次、对手名称，并简要描述问题。",
    bestOf: "{count} 局制",
    matchDeadline: "比赛截止时间：",
  },
  tournaments: {
    redesign: {
      viewArtwork: "查看海报",
      viewEvent: "查看赛事",
      showFewer: "收起赛事",
      browseAll: "浏览全部 {count} 场赛事",
      otherEvents: "其他当前赛事 · {count}",
      showLess: "收起",
      readDescription: "阅读完整描述",
      selectedEvent: "已选赛事",
      viewMaps: "查看地图",
      openArchive: "打开存档",
      historicalCount: "历史赛事 · {count}",
      mapDivision: "组别",
      chooseEvent: "浏览赛事",
      panelNavigation: "赛事信息",
    },
    organizer: "主办方",
    ...
    status: { open: "开放", inProgress: "进行中", completed: "已完成", cancelled: "已取消", closed: "已关闭", notHeld: "未举行", generated: "已生成", awaitingGeneration: "等待生成", pendingReview: "等待审核", upcoming: "即将开始" },
    divisionState: { disabled: "已禁用", filling: "招募中 — {approved}/{required}", ready: "准备开赛 — {approved}/{required}", inProgress: "进行中", completed: "已完成", notHeld: "未举行 — 未达到最低参赛人数", cancelled: "已取消", voided: "已作废" },
    eventSections: { in_competition: "比赛进行中", open: "开放赛事", resolved: "已结束赛事" },
    hero: { tournament: "锦标赛", approvedSlots: "个已批准名额", divisionInProgress: "组别进行中", divisionNotHeld: "未达到最低参赛人数", waitlistOpen: "候补名单开放", openEvents: "开放赛事", scheduleHint: "查看锦标赛赛程" },
    ...
    registrationState: {
      notHeldTitle: "组别未举行", notHeldDescription: "未达到最低参赛人数。你的报名会保留在赛事历史中，且不会获得竞技积分。",
  ...
  resultForm: {
    ...
    preparing: "正在准备安全上传回放…",
    uploading: "正在上传第 {current} 局，共 {total} 局…",
