...
const dictionary = {
  resultUx: {
    ...
    game: "Game {number}",
    you: "You",
    chooseReplay: "Choose .rec file",
    replaceReplay: "Replace replay",
    removeReplay: "Remove replay",
    gameReplay: "Game {number} replay",
    replayHint: "Attach one .rec replay per Game, in the order played. Maximum 10 MiB per file.",
    replayAttached: "Replay attached",
    derivedWinner: "Determined by the result",
    addNote: "+ Add a note",
    summary: "Result Summary",
    namedResult: "{winner} defeated {loser}, {winnerScore}–{loserScore}",
    filesAttached: "{count} of {total} replay files attached",
    afterSubmit: "Your opponent will be asked to confirm or dispute this result.",
    submit: "Submit Result",
    completeRequired: "Choose a result, attach a valid replay for every Game, and resolve the remaining Game winners.",
    waiting: "Waiting for opponent confirmation",
    reconcileTitle: "Check submission status",
    refreshSaved: "Your submission was saved. Refresh to load the official status.",
    refresh: "Refresh match",
    noShow: "Opponent did not attend? Report a no-show",
    confirmationInfo: "Result confirmation",
    windowEnded: "Confirmation window ended",
    processing: "Automatic confirmation is being processed.",
    opponentWindow: "Your opponent has {minutes} minutes from submission to confirm or dispute this result.",
    yourWindow: "You have {minutes} minutes from submission to confirm or dispute this result.",
    confirmationExplanation: "Confirm or dispute before the official confirmation deadline.",
    autoExplanation: "If no action is taken before the confirmation window expires, the result will be automatically confirmed.",
    remaining: "{minutes}m {seconds}s remaining",
    confirmationDeadline: "Confirmation deadline:",
    autoConfirmed: "Result automatically confirmed",
    confirmed: "Result confirmed",
    underReview: "Under Admin Review",
    confirmationRequired: "Result confirmation required",
    youReported: "You reported:",
    reportedBy: "{name} reported:",
    filesSubmitted: "Replay files submitted: {count}",
    expiredConfirmed: "The confirmation period expired without a dispute.",
    advanced: "The winner has advanced.",
    reviewExplanation: "An administrator is reviewing this report and its evidence.",
    stale: "This report has changed. Refresh the match before taking another action.",
    actionFailed: "The action could not be completed. Refresh the match and check its current status.",
    confirm: "Confirm Result",
    dispute: "Dispute Result",
    sendDispute: "Send dispute for Admin Review",
    details: "View submission details",
    discord: "Open Discord Support Ticket",
    discordHelp: "Include the Tournament, Round, opponent name, and a brief description of the issue in your ticket.",
  ...
  tournaments: {
    redesign: {
      ...
      otherEvents: "Other current events · {count}",
      showLess: "Show less",
      readDescription: "Read full description",
      selectedEvent: "Selected event",
      viewMaps: "View Maps",
      openArchive: "Open Archive",
      historicalCount: "Historical tournaments · {count}",
      mapDivision: "Division",
      chooseEvent: "Browse events",
      panelNavigation: "Tournament information",
    },
    organizer: "Organizer",
  ...
  resultForm: {
    ...
    preparing: "Preparing secure replay uploads…",
    uploading: "Uploading Game {current} of {total}…",
