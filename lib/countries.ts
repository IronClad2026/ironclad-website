...
export const countryCodeByCanonicalName = {
  Afghanistan: "AF",
  "Aland Islands": "AX",
  Albania: "AL",
  Algeria: "DZ",
...
export const countries = Object.keys(countryCodeByCanonicalName).sort(
...
const countryCodeByAlias: Readonly<Record<string, string>> = {
  "South Korea": "KR",
  UK: "GB",
  "Great Britain": "GB",
  USA: "US",
...
export function getCountryPresentationCode(country: string) {
  return (
    countryCodeByCanonicalName as Readonly<Record<string, string>>
  )[country] ?? countryCodeByAlias[country] ?? null;
}

export function getLocalizedCountryName(country: string, locale: Locale) {
  const code = getCountryPresentationCode(country);
