-- Fix environments that reject DELETE without WHERE during all-time
-- leaderboard recalculation. Also preserve dependent run failure details
-- when season or tournament recalculation wrappers report failure.
