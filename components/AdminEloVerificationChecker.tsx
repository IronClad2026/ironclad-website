...
import type { EloVerificationSetting } from "@/lib/platform-settings";
    ...
    <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 backdrop-blur transition hover:-translate-y-1 hover:border-orange-500/60 hover:bg-orange-500/10">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h3 className="mt-4 text-xl font-bold">ELO Verification Checker</h3>
        </div>
      ...
      <form action={updateEloVerificationMode} className="mt-4 grid gap-2 sm:grid-cols-2">
        <button
          type="submit"
          name="mode"
          value="disabled"
