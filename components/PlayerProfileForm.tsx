...
const eloRanges = [
  { label: "700-900", value: "800" },
  { label: "900-1100", value: "1000" },
  { label: "1100-1300", value: "1200" },
  { label: "1300-1500", value: "1400" },
  { label: "1500-1700", value: "1600" },
  { label: "1700-1900", value: "1800" },
  { label: "1900-2100", value: "2000" },
  { label: "2100-2300", value: "2200" },
  { label: "2300-2500", value: "2400" },
  { label: "2500-2700", value: "2600" },
  { label: "2700-2900", value: "2800" },
];
        ...
        <div className="mt-7 grid gap-5 md:grid-cols-2">
          <SearchableProfileSelect
            ...
            options={countries.map((countryOption) => ({
              label: countryOption,
              value: countryOption,
              aliases: countryAliases[countryOption],
            }))}
...
function SearchableProfileSelect({
  ...
  options: { label: string; value: string; aliases?: string[] }[];
  onSelect: (option: {
    label: string;
    value: string;
    aliases?: string[];
    ...
    <div className="min-w-0">
      ...
      <div className="relative mt-3">
        <input
          ...
          aria-expanded={open}
          aria-invalid={Boolean(error)}
          className={`w-full rounded-xl border bg-black/40 py-3 pr-11 pl-4 text-white outline-none transition placeholder:text-zinc-600 focus:border-orange-400 ${
            error ? "border-red-500/70" : "border-white/10"
          }`}
        />
        <ChevronDown
      ...
      {open && (
        <div
          id={listboxId}
          role="listbox"
          className="relative z-30 mt-2 max-h-60 w-full overflow-y-auto rounded-xl border border-white/10 bg-[#111318] p-2 shadow-2xl shadow-black/50"
        >
          {filteredOptions.length > 0 ? (
            filteredOptions.map((option) => (
              <button
                ...
                role="option"
                aria-selected={
                  submittedValue === option.value && value === option.label
                }
