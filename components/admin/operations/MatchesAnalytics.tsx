  ...
  return (
    ...
    >
      ...
      <div className="mt-5">
        ...
        <WhoDisclosure title="Confirmed no-shows" description="Recent factual no-show outcomes, distinct from withdrawals and forfeits." dateLabel="Finalized" rows={metrics.matches.who.noShows} emptyMessage="No confirmed no-show rows are available." />
      </div>
    </SectionShell>
  );
}
