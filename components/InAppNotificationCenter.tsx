...
export default function InAppNotificationCenter({
  ...
  if (error) {
    return (
      <section
        role="alert"
        className={`rounded-3xl border border-red-500/30 bg-red-500/10 p-6 shadow-xl shadow-black/20 ${className}`}
      >
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-red-100/75">
              Retry to load the latest notifications before treating this
              section as empty.
            </p>
            <button
              type="button"
