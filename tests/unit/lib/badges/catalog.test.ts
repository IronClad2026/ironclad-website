...
describe("IronClad badge catalog", () => {
  ...
  it("keeps canonical badge identity fields unchanged", () => {
    expect(
      ...
      "5|Rising Through the Ranks|rising-through-the-ranks|rare|Complete a qualifying tournament in a higher division than the first division in which you completed one.",
      ...
      "20|Flawless Campaign|flawless-campaign|legendary|Win an IronClad tournament after playing at least one official series, without losing a single individual game.",
