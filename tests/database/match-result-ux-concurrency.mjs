// Usage: node tests/database/match-result-ux-concurrency.mjs <local-psql.exe>
...
const database = "match_result_ux_races";
...
await query(`create database ${database} template postgres;`, "postgres");
